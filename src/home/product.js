    ...
    return (
                  ...
                  <div class="item" key={this.props.data.id}>
                        <div class="f_p_item">
                            ...
                            <a  href={"/product/" + this.slugify(this.props.data.name) +  "/"+ this.props.data.id } ><h4> {this.props.data .name}</h4> {this.props. data.count} {this.slugify(this.props. data.name)} </a>
